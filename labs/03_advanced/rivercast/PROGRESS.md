...
Phases 0–9 — in review; maintainer commits and opens PRs (one phase per PR). Phase 2's gate decision was PROCEED (docs/data_viability_report.md). Next: Phase 10 (implement the `rivercast-model` pipeline).
